        ...
        <section className="landing-hero">
          <div className="landing-hero-inner">
            ...
            <p className="landing-sub">
              Seeekr is a peer-to-peer platform that connects customers to local service providers, so
              you can message directly and find someone you trust — without the middleman.
            </p>
